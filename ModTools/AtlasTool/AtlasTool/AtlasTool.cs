...
namespace AtlasTool
{
  internal class AtlasTool
  {
    ...
    private void TrimTile(ref Tile _tile)
    {
      ...
      string base64String;
      lock (AtlasTool.AtlasTool.buffer)
      {
        Marshal.Copy(bitmapdata.Scan0, AtlasTool.AtlasTool.buffer, 0, _tile.originalWidth * _tile.originalHeight * 4);
        base64String = Convert.ToBase64String(SHA256.Create().ComputeHash(AtlasTool.AtlasTool.buffer, 0, _tile.originalWidth * _tile.originalHeight * 4));
      }
      Tile tile;
